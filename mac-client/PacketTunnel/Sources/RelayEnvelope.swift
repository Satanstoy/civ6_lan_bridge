...
enum RelayEnvelope {
    ...
    func encoded() throws -> Data {
        ...
        var packet = Self.magic + [Self.version, kind, UInt8(body.count >> 8), UInt8(body.count & 0xff)]
